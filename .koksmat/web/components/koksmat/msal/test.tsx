"use client";
import { GenericTable } from "@/components/koksmat/table";
...
import { DataTableColumnHeader } from "@/components/koksmat/components/data-table-column-header";
import { Button } from "@/components/ui/button";
import { GenericItem } from "@/components/koksmat/table/data/schema";
interface CaseProps {
  scopes: string[];
  title: string;
  testurl: string;
